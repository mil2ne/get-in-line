...
class EventServiceTest {
    ...
    @DisplayName("검색 조건없이 이벤트를 검색하면, 전체결과를 출력하여 보여준다")
    @Test
    void givenNothing_whenSearchingEvents_thenReturnsEntireList() throws Exception {
        // Given
    ...
    @Test
    void givenSearchParams_whenSearchingEvents_thenReturnsEventList() throws Exception {
        // Given
        Long placeId = 1L;
    ...
    @DisplayName("이벤트 id 로 존재하는 이밴트를 조회하면, 해당 이벤트 정보를 출력하여 보여준다")
    @Test
    void givenEventId_whenSearchExistingEvent_thenReturnsEvent() throws Exception {
        //Given
        Long eventId = 1L;
    ...
    @DisplayName("이벤트 id 로 이벤트를 조회하는데 데이터 관련 에러가 발생한경우, 줄서기 프로젝트 기본 에러로 전환하여 예외 던진다.")
    @Test
    ...
    @DisplayName("이벤트 id 로 없는 이벤트를 조회하면, 빈 정보를 출력하여 보여준다")
    @Test
    void givenEventId_whenSearchNonExistingEvent_thenReturnsEmptyOptional() throws Exception {
        //Given
        Long eventId = 2L;
    ...
    @Test
    void givenEvent_whenCreating_thenCreatesEventAndReturnsTrue() throws Exception {
        // Given
    ...
    @Test
    void givenNothing_whenCreating_thenAbortCreatingAndReturnsFalse() throws Exception {
        // Given
    ...
    @DisplayName("이벤트 생성 중 데이터 예외가 발생, 줄서기 프로젝트 기본 에러로 전환하여 예외 전달")
    @Test
    ...
    @DisplayName("이벤트 id 와 정보를 주면, 이벤트 정보를 변경하고 결과를 true 로 보여준다. ")
    @Test
    void givenEventIdAndItsInfo_whenModifyingEvent_thenReturnsEventTrue() throws Exception {
        //Given
        Long eventId = 1L;
    ...
    @DisplayName("이벤트 id를 주지않으면, 이벤트 정보 변경을 중단하고 결과를 false 로 보여준다. ")
    @Test
    void givenNotEventId_whenModifyingEvent_thenAbortedReturnsEventFalse() throws Exception {
        //Given
        EventDTO eventDTO = createEventDTO(1L, "오후 운동", false);
    ...
    @DisplayName("이벤트 정보를 주지않으면, 이벤트 정보 변경을 중단하고 결과를 false 로 보여준다. ")
    @Test
    void givenNotEventInfo_whenModifyingEvent_thenAbortedReturnsEventFalse() throws Exception {
        //Given
        Long eventId = 1L;
//        EventDTO eventDTO = createEventDTO(1L, "오후 운동", false);
    ...
    @DisplayName("이벤트 변경 중, 데이터 관련 에러가 발생하면, 줄서기 프로젝트 기본 에러로 변환하여 예외 전달")
    @Test
    ...
    @DisplayName("이벤트 Id 를 전달하면 이벤트를 삭제하고 결과를 true 로 반환한다.")
    @Test
    void givenEventId_whenDeleteEvent_thenReturnsEventTrue() throws Exception {
        //Given
        Long eventId = 1L;
    ...
    @DisplayName("이벤트 Id 를 전달하지 않으면 이벤트를 삭제중단 결과를 false 로 반환한다.")
    @Test
    void givenNotEventId_whenDeleteEvent_thenAbortedReturnsEventFalse() throws Exception {
        //Given
    ...
    @DisplayName("이벤트 삭제 중 데이터 관련 오류가 발생하면, 줄서기 프로젝트 기본 에러로 변환하여 예외를 전달한다.")
    @Test
    void givenDataRelatedException_whenDeleteEvent_thenThrowsGeneralException() {
        //Given
        RuntimeException e = new RuntimeException("This is yyy.");
